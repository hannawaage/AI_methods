...
if __name__ == '__main__':
  ...
  # , "Parch", "SibSp"]]
  train = rawtrain[["Survived", "Pclass", "Sex", "Fare"]]
  test = rawtest[["Survived", "Pclass", "Sex", "Fare"]]  # , "Parch", "SibSp"]]
  ...
  print("Accuracy of model when including attributes Sex , Pclass & Fare and allowing for adaptive splitting on the continous variable: ", acc)
